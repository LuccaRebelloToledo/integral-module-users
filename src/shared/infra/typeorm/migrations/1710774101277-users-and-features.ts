...
export class UsersAndFeatures1710774101277 implements MigrationInterface {
  name = 'UsersAndFeatures1710774101277';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "features" ("id" character varying(21) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "key" character varying(50) NOT NULL, "name" character varying(50) NOT NULL, CONSTRAINT "UQ_0cc5c687428b94489ce1edc3c5a" UNIQUE ("key"), CONSTRAINT "UQ_bcc3a344ae156a9fba128e1cb4d" UNIQUE ("name"), CONSTRAINT "PK_5c1e336df2f4a7051e5bf08a941" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "feature_groups" ("id" character varying(21) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "key" character varying(50) NOT NULL, "name" character varying(50) NOT NULL, CONSTRAINT "UQ_2a30a8af474dcef836abe567df9" UNIQUE ("key"), CONSTRAINT "UQ_f144e4f34cc0b1cf5aec0b2b857" UNIQUE ("name"), CONSTRAINT "PK_fccccc087ddae8137824b8a5368" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
